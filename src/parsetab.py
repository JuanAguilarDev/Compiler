...
_lr_productions = [
  ...
  ('program -> block','program',1,'p_program','Syntactic.py',24),
  ('block -> constDecl varDecl procDecl statement','block',4,'p_block','Syntactic.py',29),
  ('constDecl -> CONST constAssignmentList SEMMICOLOM','constDecl',3,'p_constDecl','Syntactic.py',34),
  ('constDecl -> empty','constDecl',1,'p_constDeclEmpty','Syntactic.py',39),
  ('constAssignmentList -> ID ASSIGN NUMBER','constAssignmentList',3,'p_constAssignmentList1','Syntactic.py',44),
  ('constAssignmentList -> constAssignmentList COMMA ID ASSIGN NUMBER','constAssignmentList',5,'p_constAssignmentList2','Syntactic.py',49),
  ('varDecl -> VAR identList SEMMICOLOM','varDecl',3,'p_varDecl1','Syntactic.py',54),
  ('varDecl -> empty','varDecl',1,'p_varDeclEmpty','Syntactic.py',59),
  ('identList -> ID','identList',1,'p_identList1','Syntactic.py',64),
  ('identList -> identList COMMA ID','identList',3,'p_identList2','Syntactic.py',69),
  ('procDecl -> procDecl PROCEDURE ID SEMMICOLOM block SEMMICOLOM','procDecl',6,'p_procDecl1','Syntactic.py',74),
  ('procDecl -> empty','procDecl',1,'p_procDeclEmpty','Syntactic.py',79),
  ('statement -> ID UPDATE expression','statement',3,'p_statement1','Syntactic.py',84),
  ('statement -> CALL ID','statement',2,'p_statement2','Syntactic.py',89),
  ('statement -> BEGIN statementList END','statement',3,'p_statement3','Syntactic.py',94),
  ('statement -> IF condition THEN statement','statement',4,'p_statement4','Syntactic.py',99),
  ('statement -> WHILE condition DO statement','statement',4,'p_statement5','Syntactic.py',104),
  ('statement -> empty','statement',1,'p_statementEmpty','Syntactic.py',109),
  ('statementList -> statement','statementList',1,'p_statementList1','Syntactic.py',114),
  ('statementList -> statementList SEMMICOLOM statement','statementList',3,'p_statementList2','Syntactic.py',119),
  ('condition -> ODD expression','condition',2,'p_condition1','Syntactic.py',124),
  ('condition -> expression relation expression','condition',3,'p_condition2','Syntactic.py',129),
  ('relation -> ASSIGN','relation',1,'p_relation1','Syntactic.py',134),
  ('relation -> NE','relation',1,'p_relation2','Syntactic.py',139),
  ('relation -> LT','relation',1,'p_relation3','Syntactic.py',144),
  ('relation -> GT','relation',1,'p_relation4','Syntactic.py',149),
  ('relation -> LTE','relation',1,'p_relation5','Syntactic.py',154),
  ('relation -> GTE','relation',1,'p_relation6','Syntactic.py',159),
  ('expression -> term','expression',1,'p_expression1','Syntactic.py',164),
  ('expression -> addingOperator term','expression',2,'p_expression2','Syntactic.py',169),
  ('expression -> expression addingOperator term','expression',3,'p_expression3','Syntactic.py',174),
  ('addingOperator -> PLUS','addingOperator',1,'p_addingOperator1','Syntactic.py',179),
  ('addingOperator -> MINUS','addingOperator',1,'p_addingOperator2','Syntactic.py',184),
  ('term -> factor','term',1,'p_term1','Syntactic.py',189),
  ('term -> term multiplyingOperator factor','term',3,'p_term2','Syntactic.py',194),
  ('multiplyingOperator -> TIMES','multiplyingOperator',1,'p_multiplyingOperator1','Syntactic.py',199),
  ('multiplyingOperator -> DIVIDE','multiplyingOperator',1,'p_multiplyingOperator2','Syntactic.py',204),
  ('factor -> ID','factor',1,'p_factor1','Syntactic.py',209),
  ('factor -> NUMBER','factor',1,'p_factor2','Syntactic.py',214),
  ('factor -> LPARENT expression RPARENT','factor',3,'p_factor3','Syntactic.py',219),
  ('empty -> <empty>','empty',0,'p_empty','Syntactic.py',224),
]
